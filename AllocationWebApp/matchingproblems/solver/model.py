...
class Model:
    ...
    def get_results(self, short_or_long, stable_correctness=False):
        ...
        filename = 'static/files/info.txt'
        f = open(filename, 'w')

        f.write('cost: ' + str(self._get_cost(pair_assignments)) + '\n')
        f.write('degree: ' + str(self._get_degree(pair_assignments)) + '\n')
        f.write('profile: ' + self._get_profile_string(self._get_profile(pair_assignments)) + '\n')
        ...
        if short_or_long == Output_type.LONG:
            ...
            filename = 'static/files/output.txt'
            f = open(filename, 'w')

            f.write(self._get_detailed_student_info(pair_assignments))
